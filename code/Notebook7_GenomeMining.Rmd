...
#Uploaded all downloaded results here: /geomicro/data21/lnhart/Projects/Kenya_2023/flagship_manuscript/FINAL2/results/antismash_drep_BGCs
```

6. Run bigscape on new antismash results
```{r}
#Bigscape was run on all antismash results after all antismash results were put into one folder with the snakefile found here and code below: /geomicro/data21/lnhart/Projects/Kenya_2023/flagship_manuscript/FINAL/data/bgc_mining/data/quality_bins/drep_99/antismash_bins99/antismash_drep_BGCs/Snakefile
